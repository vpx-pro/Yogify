      ...
      <SafeAreaView style={styles.container}>
        ...
        >
          ...
          >
            ...
            <View style={styles.inputGroup}>
              <Text style={styles.label}>
                {formData.isOnline ? 'Meeting Link' : 'Location'} <Text style={styles.required}>*</Text>
              </Text>
              <TextInput
                style={[
                  styles.input,
                  (formData.isOnline ? errors.meetingLink : errors.location) && styles.inputError
                ]}
                ...
                placeholder={formData.isOnline ? 'https://zoom.us/j/...' : 'e.g. Studio A, Main Hall'}
                editable={!loading}
              />
              {formData.isOnline && errors.meetingLink && (
                <Text style={styles.errorText}>{errors.meetingLink}</Text>
              )}
              {!formData.isOnline && errors.location && (
