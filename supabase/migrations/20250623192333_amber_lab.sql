/*
  ...
  1. New Features
    ...
    - Default value: 'pending' for all bookings
    - Proper indexing for payment status queries
    - Validation constraints for payment/booking status alignment

  2. Security
    - Updated RLS policies for payment status operations
    - Secure function for payment status transitions
    - Proper validation of status changes

  3. Data Migration
    - All existing bookings set to 'pending' payment status
    - Added updated_at column and trigger for bookings table
*/
