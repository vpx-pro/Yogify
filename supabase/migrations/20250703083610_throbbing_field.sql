/*
  # Add Teacher Features and Review System

  1. New Tables
    - `teacher_profiles` - Extended teacher information
    - `saved_teachers` - Student's favorite teachers
    - `teacher_reviews` - Reviews for teachers
    - `teacher_ratings` - Aggregated teacher ratings

  2. New Columns
    - Add social links, bio, experience to teacher profiles
    - Add review system with ratings and comments

  3. Functions
    - Calculate and update teacher ratings
    - Manage saved teachers

  4. Security
    - RLS policies for all new tables
    - Proper access control for reviews and favorites
*/
