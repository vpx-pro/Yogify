/*
  # Fix Duplicate Booking Error and Implement Participant Count Management

  1. Database Functions
    - create_booking_with_count: Safely creates bookings with duplicate checking
    - cancel_booking_with_count: Cancels bookings with count management
    - sync_participant_count: Synchronizes stored counts with actual data
    - validate_all_participant_counts: Validates all class counts

  2. Audit System
    - participant_count_audit table for tracking all count changes
    - Comprehensive logging of all participant count modifications

  3. Triggers
    - Automatic count adjustment when payment status changes
    - Real-time synchronization of participant counts
